...
def reconstructable_repository(target: "RepositoryDefinition") -> ReconstructableRepository:
    ...
    if code_pointer:
        ...
        raise DagsterInvariantViolationError(
            "reconstructable_repository() can only reconstruct repositories that are defined "
            "within a module, at module scope. It cannot not reconstruct repositories defined in "
            "interactive environments like <stdin>, IPython, or Jupyter notebooks."
        )
